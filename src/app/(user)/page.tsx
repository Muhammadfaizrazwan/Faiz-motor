...
export const metadata = {
  title: "MotoMart — Marketplace Motor Terpercaya",
  ...
  return (
    <div>
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex items-center justify-center gap-8 mt-8 mb-8">
              <div className="text-center">
                <p className="text-2xl font-bold text-white">{totalMotors}+</p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {BRAND_LIST.map((brand) => (
              <Link
                ...
                className="group relative bg-white rounded-2xl border border-slate-100 p-6 text-center hover:shadow-xl hover:shadow-slate-200/50 hover:-translate-y-1 transition-all duration-300"
              >
      ...
      {reviews.length > 0 && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
          <div className="text-center mb-10">
            ...
            <p className="text-sm text-[#64748B] mt-1">Testimoni dari pelanggan setia MotoMart</p>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 lg:pb-16">
        <div className="relative bg-gradient-to-r from-[#0A1628] to-[#1E3A5F] rounded-3xl overflow-hidden px-6 sm:px-12 py-12 sm:py-16">
          ...
          <div className="relative text-center max-w-xl mx-auto">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">Tertarik dengan Motor Kami?</h2>
            <p className="text-slate-400 text-sm sm:text-base mb-6">Hubungi kami sekarang untuk informasi lebih lanjut atau kunjungi showroom kami.</p>
            <a
              href="https://wa.me/6281234567890?text=Halo%20MotoMart%2C%20saya%20tertarik%20dengan%20motor%20di%20website%20Anda"
              target="_blank"
